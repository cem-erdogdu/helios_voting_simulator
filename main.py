...
def demo_bulletin_board(keypair):
    ...
    for voter_id, vote in voters:
        ...
        success, message = board.post_ballot(voter_id, ciphertext, proof)
    ...
    success, message = board.post_ballot("alice", ct_dup, proof_dup)
    ...
    success, message = board.post_ballot("hacker", ct_tampered, proof_valid)
